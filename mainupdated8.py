...
import config3
logging.basicConfig(filename="file8.log",level=logging.INFO,format="%(asctime)s:%(levelname)s:%(message)s")

#707
url = "https://www.binance.com/en/futures-activity/leaderboard?type=myProfile&tradeType=PERPETUAL&encryptedUid=774021F7C5EF25DCF166C0351FB2B38C"
