...
import config3
logging.basicConfig(filename="file5.txt",level=logging.INFO,format="%(asctime)s:%(levelname)s:%(message)s")

#ENJIN2016
url = "https://www.binance.com/en/futures-activity/leaderboard?type=myProfile&tradeType=PERPETUAL&encryptedUid=A6C4A0DE1ED6FEFEAB424926A78AC735"
saved_list = [] 
